...
#ifndef PROC_MAPPING_SUBMARINEPOSITION_H
#define PROC_MAPPING_SUBMARINEPOSITION_H
...
SubmarinePosition::OdometryCallback(const nav_msgs::Odometry::ConstPtr &odo_in) {
  position_xyz_[X] = odo_in->twist.twist.linear.x;
  position_xyz_[Y] = odo_in->twist.twist.linear.y;
  position_xyz_[Z] = odo_in->twist.twist.linear.z;
  orientation_rpy_[ROLL] = odo_in->twist.twist.angular.x;
  orientation_rpy_[PITCH] = odo_in->twist.twist.angular.y;
  orientation_rpy_[YAW] = odo_in->twist.twist.angular.z;

  orientation_quaternion_.x() = odo_in->pose.pose.orientation.x;
  orientation_quaternion_.y() = odo_in->pose.pose.orientation.y;
  orientation_quaternion_.z() = odo_in->pose.pose.orientation.z;
  orientation_quaternion_.w() = odo_in->pose.pose.orientation.w;
