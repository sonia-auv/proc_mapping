...
inline boost::any BlobDetector::ProcessData(boost::any input) {
  ...
  params_.minCircularity = min_circularity_;
  params_.maxCircularity = max_circularity_;
  params_.filterByConvexity = filter_by_convexity_;
  params_.minConvexity = min_convexity_;
  params_.maxConvexity = max_convexity_;
  params_.filterByInertia = filter_by_inertia_;
  params_.minInertiaRatio = min_inertia_ratio_;
  params_.maxInertiaRatio = max_inertia_ratio_;
