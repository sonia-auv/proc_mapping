                     ...
                     ::coder::array<double, 2U> &filteredRangeData)
{
  ...
  numx = (static_cast<int>(
              std::floor(::coder::internal::maximum(b_location) * 100.0)) -
          static_cast<int>(std::floor(range_idx_0 * 100.0))) +
         1;
  matrixIndex = i1 - i;
  b_location.set_size(1, matrixIndex);
